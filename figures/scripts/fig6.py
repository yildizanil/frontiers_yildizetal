...
acheron = ScalarEmulators('acheron',h_threshold=0.1, loc_x=1490100, loc_y=5204100)
...
scalars = list(acheron.output.columns)

predicted = {}
for scalar in scalars:
    predicted[scalar] = acheron.predict_scalar(scalar,input_mcs3.to_numpy())[0]
