...
ac_pem = fy.Simulations('acheron_pem').create_vector(qoi='hmax',threshold=0.1,valid_cols=ac.valid_cols)
...
c1 = ax1.imshow(pem3_mean_ma, cmap='viridis', extent=plotting_extent(hill),zorder=1,vmin=0.1,vmax=80)
fig.colorbar(c1,ax=ax1,location='top', orientation='horizontal', label='Mean flow height [m]')
ax1.set_ylabel('Northing [x 10$^6$ m]')
ax1.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=None)
ax1.set_yticks(ticks=np.arange(5201000, 5205001,1000),
...
fig.colorbar(c2, ax=ax2, location='top', orientation='horizontal', label='Mean flow height [m]')
ax2.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=[1.498,'1.490',1.491,1.492,1.493])
ax2.set_yticks(ticks=np.arange(5201000, 5205001,1000),
               labels=[5.201, 5.202,5.203,5.204,5.205])
...
ax3.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=[1.498,'1.490',1.491,1.492,1.493])
...
c4 = ax4.imshow(pem3_sd_ma, cmap='viridis', extent=plotting_extent(hill),zorder=1,vmin=0.1,vmax=40)
fig.colorbar(c4, ax=ax4, location='top', orientation='horizontal', label='Std. deviation flow height [m]')
ax4.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=[1.498,'1.490',1.491,1.492,1.493])
...
fig.colorbar(c5, ax=ax5, location='top', orientation='horizontal', label='Std. deviation flow height [m]')
ax5.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=[1.498,'1.490',1.491,1.492,1.493])
...
ax6.set_xticks(ticks=np.arange(1489000, 1493600,1000),
               labels=[1.498,'1.490',1.491,1.492,1.493])
